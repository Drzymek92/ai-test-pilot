...
def discover(project_root: Path, adapter) -> list[ModuleReport]:
...
def format_report(project_root: Path, reports: list[ModuleReport]) -> str:
    lines = [f"# Discoverable test targets — {project_root.name}", ""]
